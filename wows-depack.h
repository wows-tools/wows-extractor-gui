...
/**
 * @brief Lists the contents of a directory in the WoWs archive.
 *
 * This function lists all files and directories in the specified directory path.
 * The results array will contain entries in the format "name" for files and "name/" for directories.
 * The path can be either absolute (starting with '/') or relative to the current directory.
 *
 * @param context The WOWS_CONTEXT object representing the root of the archive tree.
 * @param dir_path The path of the directory to list. Can be absolute or relative.
 * @param[out] result_count A pointer to an integer that will receive the number of entries found.
 * @param[out] results A pointer to an array of strings that will receive the names of the entries.
 * @return 0 on success, or an error code if an error occurred.
 */
int wows_readdir(WOWS_CONTEXT *context, char *dir_path, int *result_count, char ***results);

/**
 * @brief Changes the current working directory in the WoWs archive.
 *
 * This function changes the current working directory to the specified path.
 *
 * @param context The WOWS_CONTEXT object representing the root of the archive tree.
 * @param dir_path The path of the directory to change to.
 * @return 0 on success, or an error code if an error occurred.
 */
int wows_changedir(WOWS_CONTEXT *context, char *dir_path);
